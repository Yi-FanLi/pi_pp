...
#dist=coords_O[:, None, :]-coords_H[:, :, None]
...
dists_array = np.zeros([nsamp, nO*nH])
...
for iloop in range(nloop):
  ...
  for ibatch in range(nbatch):
    ...
    #dists_array[isamp] = dist_r[ibatch].reshape(nO*nH)
...
if rank==0:
  ...
  #print(g_r.shape)
  np.save(directory+"goh.npy", np.c_[r_array_10.reshape(10*nbin), g_r.reshape(10*nbin)].reshape(10, nbin, 2))
  #print(g_r.shape)
  #plt.xlim(2, 7.5)
